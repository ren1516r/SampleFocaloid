...
public class menu_map extends Fragment implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener
        ,LocationListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       SupportMapFragment mapFragment = (SupportMapFragment) fm.findFragmentById(R.id.map);
        mapFragment.getMapAsync((OnMapReadyCallback) myContext);*/
...
if(latLng!=null){
   ...
   /* public void onCreate(Bundle savedInstanceState) {
    ...
    public void onLocationChanged(Location location) {
        ...
        display=(TextView)getActivity().findViewById(R.id.latlongLocation);

        display.setText(String.valueOf(latLng));

        Log.d("lat", String.valueOf(mLastLocation.getLatitude()));
        Log.d("longt", String.valueOf(mLastLocation.getLongitude()));
